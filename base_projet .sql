...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 22 déc. 2021 à 21:28
...
('Annon1', 'Transport matériels de logistique', 'Bonjour,\r\nJe suis a la recherche d\'un transport d\'un matériel de logistique depuis le port de Bejaia vers la ville de Hydra Alger.', 'Port de Bejaïa.', 'Rue de frères Kadri Hydra, Alger.', 1, 20000, 'Logistique', 'Entre 100 a 1000 kg.', 'Entre 0 a 10 mètres cubes.', 'Transport par camions.', 'valide.', '2021-12-21 14:14:50', 0, NULL),
...
('Annon3', 'Transport d\'un colie de toute urgence.', 'Bonjour,\r\nJe suis a la recherche d\'un transport pour un colie de la plus haute importance depuis la ville d\'Oran vers la ville de Berrouaghia,Medea. Le transport doit etre effectuée le plus vite possible', 'la ville d\'Oran', 'Berrouaghia,Medea', 0, 20000, 'Colis leger', 'Entre 1 a 10 kg.', 'Entre 0 a 1 mètres cubes.', 'N\'import quel type', 'valide.', '2021-12-21 16:00:50', 0, NULL),
('Annon4', 'Transport de transformateurs electriques.', 'Bonjour,\r\nMa société est a la recherche d\'un transport pour 3 transformateurs électriques depuis la ville de Tizi-Ouzou vers la ville de Boudouaou, Boumerdes.\r\nCordialement.', 'Ville de Tizi-Ouzou.', 'ville de Boudouaou, Boumerdes', 1, 90000, 'Transport de machines industriels.', 'Entre 1000 a 10000 kg.', 'Entre 1 a 10  mètres cubes.', 'Par camions.', 'Valide.', '2021-12-21 14:30:31', 0, NULL),
('Annon5', 'Transport de materiels medicales.', 'Bonjour,\r\nMa société est a la recherche d\'un transport pour du materils medicale tres chere depuis le port d\'Arzew,Oran vers l\'e CHU Nadir Mohamed de la ville de Tizi-Ouzou.\r\nCordialement.', 'Arzew,Oran.', 'CHU Nadir Mohamed de la ville de Tizi-Ouzou.', 1, 120000, 'Transport de materiels medicales.', 'Entre 1000 a 10000 kg.', 'Entre 10 a 100  mètres cubes.', 'Par camions.', 'Valide.', '2021-12-21 17:30:31', 0, NULL),
...
INSERT INTO `news` (`id_news`, `titre`, `description`, `nombres_vues`) VALUES
